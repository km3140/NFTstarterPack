...
contract flightLog{
    ...
    // 로깅 시작
    function logging(string memory _takeOffTime, string memory _flightNum) public {
        logs.push(Log(_takeOffTime,"",false,false,string.concat("HL-",_flightNum),msg.sender));
    }
